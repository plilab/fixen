...
slug: 26.07/guides/language-essentials/02-rules-and-inference
---
...
The expression `b ++ "-" ++ c` is evaluated as Haskell code using the instantiated variable values. See [Haskell Interop](../07-haskell-interop/) for details on embedding Haskell in your programs.
