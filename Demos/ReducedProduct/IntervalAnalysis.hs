...
insertDB fact db =
    let update hset vnew =
            if not (S.null hset) && any (`subsumes` vnew) hset
                then (hset, False)
                else
                    let hset' = S.filter (not . (vnew `strictlySubsumes`)) hset
                     in (S.insert vnew hset', True)
     in case fact of
            StateBeforeFact (StateBefore v0 v1) ->
                if M.member v0 (factsStateBefore db)
                    then
                        first
                            ( \hset ->
                                db
            ...
            SeqFact (Seq v0 v1) ->
                if S.member (v0, v1) (factsSeq db)
                    then (db, False)
                    else (db{factsSeq = S.insert (v0, v1) (factsSeq db)}, True)
            VarFact (Var v0 v1) ->
                if S.member (v0, v1) (factsVar db)
                    then (db, False)
                    else (db{factsVar = S.insert (v0, v1) (factsVar db)}, True)
            CondFact (Cond v0 v1 v2 v3) ->
                if M.member v0 (factsCond db)
                    then
                        first
                            ( \hset ->
                        ...
                        ( db
                            { factsCond =
                                M.insert
                                    v0
                                    (S.singleton (v1, v2, v3))
                                    (factsCond db)
                            }
                        , True
                        )
            AssignFact (Assign v0 v1 v2) ->
                if M.member (v0, v1) (factsAssign db)
                    then
                        first
                            ( \hset ->
                                db
    ...
    case fact of
        SeqFact (Seq v_2 v_3) ->
            Q.unions
                [ q_1
                , foldl'
                    ( \q_4 (Seq lAssign0 lAfter0) ->
                        Q.unions
                            [ q_4
                            , foldl'
                                ( \q_6 (StateBefore lAfter0_5 stAfter0) ->
                                    Q.unions
                                        [ q_6
                                        , foldl'
                                            ( \q_8 (StateBefore lAssign0_7 stAssign0) ->
                                                Q.unions
                                                    [ q_8
                                                    , foldl'
                                                        ( \q_10 (Assign lAssign0_7_9 x0 e2) ->
                                                            Q.unions
                                                                [ q_10
                                                                , Q.singleton
                                                                    ( AssignStepCont
                    ...
                    Q.empty
                    ( S.foldl'
                        (\rest (v_18, v_19) -> Seq v_18 v_19 : rest)
                        []
                        (S.singleton (v_2, v_3))
                    )
                ]
        CondFact (Cond v_20 v_21 v_22 v_23) ->
            Q.unions
                [ q_1
                , foldl'
                    ( \q_24 (Cond lcond0 e0 jlt0 jlf0) ->
                        Q.unions
                            [ q_24
                            , foldl'
                                ( \q_26 (StateBefore jlf0_25 stf0) ->
                                    Q.unions
                                        [ q_26
                                        , foldl'
                                            ( \q_28
                                               (StateBefore lcond0_27 stc0) ->
                                                    Q.unions
                                                        [ q_28
                                                        , if leq
                                                            BFalse
                            ...
                            , foldl'
                                ( \q_34 (StateBefore jlt0_33 stt0) ->
                                    Q.unions
                                        [ q_34
                                        , foldl'
                                            ( \q_36
                                               (StateBefore lcond0_35 stc1) ->
                                                    Q.unions
                                                        [ q_36
                                                        , if leq
                                                            BTrue
                            ...
                            , Q.singleton
                                (CondInitCont lcond0 e0 jlt0 jlf0)
                            ]
                    )
                    Q.empty
                    ( M.foldlWithKey'
        ...
        AssignFact (Assign v_45 v_46 v_47) ->
            Q.unions
                [ q_1
                , foldl'
                    ( \q_48 (Assign lAssign0 x0 e2) ->
                        Q.unions
                            [ q_48
                            , foldl'
                                ( \q_49 (StateBefore lAfter0 stAfter0) ->
                                    Q.unions
                                        [ q_49
                                        , foldl'
                                            ( \q_51
        ...
        VarFact (Var v_64 v_65) ->
            Q.unions
                [ q_1
                , foldl'
                    ( \q_66 (Var l0 x1) ->
                        Q.unions [q_66, Q.singleton (VarInitCont l0 x1)]
                    )
                    Q.empty
                    ( S.foldl'
                        (\rest (v_67, v_68) -> Var v_67 v_68 : rest)
                        []
                        (S.singleton (v_64, v_65))
                    )
                ]
        StateBeforeFact (StateBefore v_69 v_70) ->
            Q.unions
                [ q_1
                , foldl'
                    ( \q_71 (StateBefore jlf0 stf0) ->
                        Q.unions
                            [ q_71
                            , foldl'
                                ( \q_73
                                   (Cond lcond0 e0 jlt0 jlf0_72) ->
                                        Q.unions
                                            [ q_73
                                            , foldl'
                                                ( \q_75
                            ...
                            , foldl'
                                ( \q_112
                                   (StateBefore lAssign0 stAssign0) ->
                                        Q.unions
                                            [ q_112
                                            , foldl'
                                                ( \q_114
