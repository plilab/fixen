...
step db fact q_1
  = case fact of
                                   ...
                                   [q_1,
                                    foldl'
                                      ...
                                      (S.foldl' (\ rest (v_18, v_19) -> Seq v_18 v_19 : rest) []
                                         (S.singleton (v_2, v_3)))]
        CondFact (Cond v_20 v_21 v_22 v_23) -> Q.unions
                                                 [q_1,
                                                  foldl'
        ...
        AssignFact (Assign v_45 v_46 v_47) -> Q.unions
                                                [q_1,
                                                 foldl'
                                                   ...
                                                   (M.foldlWithKey'
                                                      ...
                                                      (M.singleton (v_45, v_46)
                                                         (S.singleton v_47)))]
        VarFact (Var v_64 v_65) -> Q.unions
                                     [q_1,
                                      foldl'
                                        (\ q_66 (Var l0 x1) ->
        ...
        StateBeforeFact (StateBefore v_69 v_70) -> Q.unions
                                                     [q_1,
                                                      foldl'
