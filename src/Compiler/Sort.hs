...
sortRule :: Rule (Premise Var) (PropositionOf e2 Var)
         -> Rule (Premise Var) (PropositionOf e2 Var)
...
sortPremise (PremiseAssumption assump) = PremiseAssumption (sortProp assump)
sortPremise premiseCondition = premiseCondition
