...
instance Ord RuleInstance where
  ...
  (RuleAssignStepI _ _ _ _ _ _) < (RuleAssignInitI _) = True
  (RuleEvalCondTI _ _ _ _ _) < (RuleAssignInitI _) = True
  (RuleEvalCondFI _ _ _ _ _) < (RuleAssignInitI _) = True
  (RuleAssignStepI _ _ _ _ _ _) < (RuleCondInitI _) = True
  (RuleEvalCondTI _ _ _ _ _) < (RuleCondInitI _) = True
  (RuleEvalCondFI _ _ _ _ _) < (RuleCondInitI _) = True
  (RuleAssignStepI _ _ _ _ _ _) < (RuleVarInitI _) = True
  (RuleEvalCondTI _ _ _ _ _) < (RuleVarInitI _) = True
  (RuleEvalCondFI _ _ _ _ _) < (RuleVarInitI _) = True
  (RuleAssignStepP _ _ _ _ _ _) < (RuleAssignInitP _) = True
  (RuleEvalCondTP _ _ _ _ _) < (RuleAssignInitP _) = True
  (RuleEvalCondFP _ _ _ _ _) < (RuleAssignInitP _) = True
  (RuleAssignStepP _ _ _ _ _ _) < (RuleCondInitP _) = True
  (RuleEvalCondTP _ _ _ _ _) < (RuleCondInitP _) = True
  (RuleEvalCondFP _ _ _ _ _) < (RuleCondInitP _) = True
  (RuleAssignStepP _ _ _ _ _ _) < (RuleVarInitP _) = True
  (RuleEvalCondTP _ _ _ _ _) < (RuleVarInitP _) = True
  (RuleEvalCondFP _ _ _ _ _) < (RuleVarInitP _) = True
  (RuleAssignStepI _ l _ _ _ _) < (RuleAssignStepI _ l' _ _ _ _) = l > l'
  (RuleEvalCondTI _ l _ _ _) < (RuleAssignStepI _ l' _ _ _ _) = l > l'
  (RuleEvalCondFI _ _ l _ _) < (RuleAssignStepI _ l' _ _ _ _) = l > l'
  (RuleAssignStepI _ l _ _ _ _) < (RuleEvalCondTI _ l' _ _ _) = l > l'
  (RuleEvalCondTI _ l _ _ _) < (RuleEvalCondTI _ l' _ _ _) = l > l'
  (RuleEvalCondFI _ _ l _ _) < (RuleEvalCondTI _ l' _ _ _) = l > l'
  (RuleAssignStepI _ l _ _ _ _) < (RuleEvalCondFI _ _ l' _ _) = l > l'
  (RuleEvalCondTI _ l _ _ _) < (RuleEvalCondFI _ _ l' _ _) = l > l'
  (RuleEvalCondFI _ _ l _ _) < (RuleEvalCondFI _ _ l' _ _) = l > l'
  (RuleAssignStepP _ l _ _ _ _) < (RuleAssignStepP _ l' _ _ _ _) = l > l'
  (RuleEvalCondTP _ l _ _ _) < (RuleAssignStepP _ l' _ _ _ _) = l > l'
  (RuleEvalCondFP _ _ l _ _) < (RuleAssignStepP _ l' _ _ _ _) = l > l'
  (RuleAssignStepP _ l _ _ _ _) < (RuleEvalCondTP _ l' _ _ _) = l > l'
  (RuleEvalCondTP _ l _ _ _) < (RuleEvalCondTP _ l' _ _ _) = l > l'
  (RuleEvalCondFP _ _ l _ _) < (RuleEvalCondTP _ l' _ _ _) = l > l'
  (RuleAssignStepP _ l _ _ _ _) < (RuleEvalCondFP _ _ l' _ _) = l > l'
  (RuleEvalCondTP _ l _ _ _) < (RuleEvalCondFP _ _ l' _ _) = l > l'
  (RuleEvalCondFP _ _ l _ _) < (RuleEvalCondFP _ _ l' _ _) = l > l'
  _ < _ = False
